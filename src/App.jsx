...
const scenes = [
  ...
  },
  {
    ...
    me: "Катя — знакомая друзей с ДВ. Мы общались компанией, шутили. Без флирта, встреч или намёков. Я понимаю, что со стороны это выглядит отвратительно. Измены не было, но я осознаю, как это задело тебя."
  },
  {
  ...
  },
  {
    ...
    me: "Нет, никогда. С момента как мы начали встречаться я был с тобой и выбирал только тебя. Все мои мысли и чувства были о нас. Если я когда-то и отвлекался, то это были мои глупые шутки в голове, несвязанные с реальностью."
  },
  {
    her: "Откуда у тебя паническая ревность?",
    me: "Я боялся тебя потерять. Когда ты начала общаться и играть с ребятами и бывшим, я почувствовал угрозу там, где, возможно, её и не было. Вместо того чтобы довериться тебе и спокойно сказать, что мне больно и страшно, я начал накручивать себя и реагировать неправильно. Это моя слабость, и это то, над чем мне нужно работать."
  },
  {
  ...
  },
  {
    ...
    me: "Это было на эмоциях. Я закрылся и повёл себя глупо. Это не было попыткой что-то скрыть — просто детская реакция, за которую мне стыдно."
  },
  {
  ...
  },
  {
    ...
    me: "Я не могу быть уверен в будущем. Но я знаю, что хочу бороться за нас. Если ты тоже этого хочешь, мы сможем пройти через это вместе. Не могу обещать идеал, но готов делать конкретные шаги, чтобы восстановить доверие"
  },
  {
